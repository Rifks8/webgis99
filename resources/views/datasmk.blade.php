            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">Data SMKN</div>
                    </div>
                    ...
                    <div class="ml-12">
                        ...
                        <a href="/datasmk/create"><button class="mb-8 bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Tambah data</button></a>
                        ...
                        <table class="border-collapse border border-green-800 table-fixed">
                            ...
                            @foreach( $smk as $smkn )
                                <tr>
                                    ...
                                    <td class="border-4 border-red-600 text-lg">{{ $smkn -> nama }}</td>
                                    <td class="border-4 border-blue-600">{{ $smkn -> alamat }}</td>
                                    <td class="border-4 border-pink-600 text-lg">{{ $smkn -> keterangan }}</td>
                                    <td class="border-4 border-pink-600"><img src="{{ asset('img/'.$smkn -> foto) }}" class="card-img-top" height="300"></td>
                                    <td class="border-4 border-yellow-600">
                                        <form action="/datasmk/{{ $smkn->id }}/edit">
                                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Ubah</button>
                                        </form>
                                        <form action="/datasmk/{{ $smkn -> id }}" method="POST">
                                        @method('delete')
                                        @csrf
